...
<div>
          ...
          <Link href={'/'} className='text-[40px]' >remeni</Link>
...
<div className='flex items-center gap-23'>
          ...
          <button onClick={handelMode}><MdLightMode className='text-[30px]' /></button>
          <button className='w-[136px] text-[16px] font-medium font-main text-[#F9FAFB] bg-main rounded-2xl py-1.5 dark:bg-red-500 '>Download CV</button>
          </div>
</div>
